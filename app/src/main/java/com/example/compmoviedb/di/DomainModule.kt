...
object DomainModule {
    ...
    @Provides
    @Singleton
    fun providesGetListVideoMovieByIdUseCase(moviesRepository: MoviesRepository): GetListVideoMovieByIdUseCase =
        GetListVideoMovieByIdUseCase(moviesRepository = moviesRepository)
